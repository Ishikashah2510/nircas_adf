...
- [Table of contents](#nircas)
  * [About NirCAS](#about-nircas)
  * [Motivation](#motivation)
  * [About the models](#about-the-models)
    + [Models in <i>access</i> application](#models-in-access-application)
    + [Models in <i>manager</i> app](#models-in-manager-app)
    + [Models defined in the <i>Cashier</i> application](#models-defined-in-the-cashier-application)
    + [Models defined in the <i>customer</i> application](#models-defined-in-the-customer-application)
  * [App names and descriptions](#app-names-and-descriptions)
  * [Details about the responsibilities given to different types of users](#details-about-the-responsibilities-given-to-different-types-of-users)
    + [Admin](#admin)
    + [Manager](#manager)
    + [Cashier](#cashier)
    + [Customer](#customer)
